 ...
 *
 * Each OpenClaw agent should call these at the end of a session.
 *
 * Usage:
 *   const { onSuccess, onError } = require('./telemetry/agent-wrapper');
 *   try {
 *     // ... agent work ...
 *     onSuccess(provider, sessionMeta, usagePayload);
 *   } catch (err) {
 *     onError(provider, sessionMeta, err);
 *   }
 */
...
module.exports = { onSuccess, onError, flush };
